    ...
    var It = ({
            ...
            let l = e.slice(0, 2).map((E, c) => {
                let b = parseFloat(E.getAttribute(M.start.key) || `${c===0?n:o}`),
                    ...
                    g = t[c],
                    I = r[c];
                return f < n && (T.alert(`The Handle start value [${f}] doesn't match the range, so it has been set to the min value [${n}].`, "info"), f = n), f > o && (T.alert(`The Handle start value [${f}] doesn't match the range, so it has been set to the max value [${o}].`, "info"), f = o), new B(E, {
                    index: c,
                    minRange: n,
                    maxRange: o,
                    trackWidth: i,
